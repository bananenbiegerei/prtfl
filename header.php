...
<?php if (!is_front_page()) : ?>
    ...
    >
    <header
        class="fixed top-0 left-0 w-screen z-50 transition-all duration-300 h-desktop-header p-4 pr-6 bg-primary rounded-b-abcd shadow-bb-custom overflow-hidden"
        :class="{ 'md:pb-4 h-mobile-header': isScrolled }">
    ...
    <div class="h-desktop-header transition-all duration-300" :class="{ '!h-mobile-header': isScrolled }">
