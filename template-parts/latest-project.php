...
?>
<div class="px-6 sm:px-12 sm:flex justify-center">
    <div class="container">
        <h2 class="mb-2 bg-primary text-accent py-2 px-4 rounded-xl animate-bounce inline-block"><?php _e('latest project', BB_TEXT_DOMAIN); ?></h2>
