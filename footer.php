...
<footer class="site-footer grid grid-cols-1 content-center" aria-labelledby="footer-heading">
	  ...
	  <div class="mt-8 xl:mt-0">
		...
		<form class="mt-4 sm:flex sm:max-w-md">
		  ...
		  <div class="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
			<button type="submit" class="w-full flex items-center justify-center button">Subscribe</button>
		  </div>
		</form>
	  </div>
	</div>
