<?php 
	...
	*/
	...
	add_filter('acf/update_value/key=field_5f5778364b810', 'acf_reciprocal_relationship', 10, 3);
	// if you are using 2 relationship fields on different post types
	// add second filter for that fields as well
    add_filter('acf/update_value/key=field_602cedb588058', 'acf_reciprocal_relationship', 10, 3);
